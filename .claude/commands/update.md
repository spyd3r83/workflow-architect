Self-improve the Workflow Designer Agent package.

Usage: /update

This command analyzes the package's own performance, identifies weaknesses from defect patterns, proposes improvements, gets Oracle review, applies changes through an eval gate, and versions the result.
